...
export const GET_MACHINES = "GET_UNITS";
export const GET_MACHINE = "GET_UNIT";
export const ADD_MACHINE = "ADD_UNIT";
export const DELETE_MACHINE = "DELETE_UNIT";
export const EDIT_MACHINE = "EDIT_UNIT";
